...
# ---------------------- set env path ----------------------
TEST_CODE_DIR="$HOME/projects/adGraphTest/multi_node_test" 
LAPACK_INSTALL_ROOT="$HOME/projects/lapack-3.12.0/install"
NVGRAPH_LIB_DIR="$HOME/projects/adGraph/dist/lib64" 
NVGRAPH_INCLUDE_DIR="$HOME/projects/adGraph/dist/include/nvgraph"
...
for TEST_FILE in ${TEST_CODE_DIR}/adgraph_test*.cpp; do
    ...
    hipcc -std=c++14 ${TEST_FILE} -g -o ${OUTPUT_NAME} \
        ...
        -lhipblas -lrocsparse -lrocrand -lrocsolver -lhipsparse -lamdhip64 \
        -lpthread \
        $MPI_LINK_FLAGS
