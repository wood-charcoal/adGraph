...
hipsparseStatus_t  CUSPARSEAPI cusparseZcsrxtrsm(
    ...
    hipsparseStatus_t CUSPARSEAPI hipsparseScsrmm3(
        hipsparseHandle_t handle,
        hipsparseOperation_t transa,
    ...
    hipsparseStatus_t CUSPARSEAPI hipsparseScsrmm4(
        hipsparseHandle_t handle,
        hipsparseOperation_t transa,
        hipsparseOperation_t transb,
        int m,
    ...
    hipsparseStatus_t CUSPARSEAPI hipsparseScsrmm5(
        hipsparseHandle_t handle,
        hipsparseOperation_t transa,
        hipsparseOperation_t transb,
        int m,
    ...
    hipsparseStatus_t CUSPARSEAPI hipsparseScsrmm6(
        hipsparseHandle_t handle,
        hipsparseOperation_t transa,
        hipsparseOperation_t transb,
        int m,
