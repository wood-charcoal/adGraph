...
namespace nvgraph
{
                          ...
                          IndexType_ &iter)
    {
        ...
        // }
        // else {
        CHECK_HIPSOLVER(hipsolverDnGetStream(cusolverHandle, &s_cusolver));
        CHECK_HIPSOLVER(hipsolverDnSetStream(cusolverHandle, s_alg));
        //}
        ...
        // }
        // else {
        CHECK_HIPSOLVER(hipsolverDnSetStream(cusolverHandle, s_cusolver));
        //}
